...
plot_a_list(Li_Ca_ratios_612, 7,2, ylim = c(0,.6), xlim = c(0,200), guides = "collect")
...
plot_a_list(Li_Ca_ratios_JCP, 7,2, ylim = c(0,.01), xlim = c(0,200), guides = "collect")
...
plot_a_list(Li_Ca_ratios_DSC, 7,2, ylim = c(0,.005), xlim = c(0,200), guides = "collect")
...
Analysis <- Runs_Sample_23_16_1[[j]] %>%
  filter(`Time [Sec]` >= 40 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-56) %>% # analysis started at 40 seconds and finished 56 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_16_2[[j]] %>%
  filter(`Time [Sec]` >= 40 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-56) %>% # analysis started at 32 seconds and finished 56 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_16_3[[j]] %>%
  filter(`Time [Sec]` >= 38 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-58) %>% # analysis started at 38 seconds and finished 58 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_1_1[[j]] %>%
  filter(`Time [Sec]` >= 41 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-58) %>% # analysis started at 41 seconds and finished 58 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_1_2[[j]] %>%
  filter(`Time [Sec]` >= 41 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-59) %>% # analysis started at 41 seconds and finished 58 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_1_3[[j]] %>%
  filter(`Time [Sec]` >= 40 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-59) %>% # analysis started at 32 seconds and finished 51 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_10_1[[j]] %>%
  filter(`Time [Sec]` >= 40 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-57) %>% # analysis started at 35 seconds and finished 55 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_10_2[[j]] %>%
  filter(`Time [Sec]` >= 44 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-55) %>% # analysis started at 44 seconds and finished 55 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_10_3[[j]] %>%
  filter(`Time [Sec]` >= 41 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-56) %>% # analysis started at 42 seconds and finished 55 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_6_1[[j]] %>%
  filter(`Time [Sec]` >= 47 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-80) %>% # analysis started at 47 seconds and finished 80 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
Analysis <- Runs_Sample_23_6_2[[j]] %>%
  filter(`Time [Sec]` >= 42 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-70) %>% # analysis started at 42 seconds and finished 70 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
