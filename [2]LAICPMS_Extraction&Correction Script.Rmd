...
plot_a_list <- function(master_list_with_plots, no_of_rows, no_of_cols, ylim, xlim) {
...
Signals_graph_folder <- "~/Library/CloudStorage/OneDrive-UniversityofSouthampton/PhD, INSPIRE DTP/Countries_Chapters/UK [Soton]/Chpt4 Bamboo Coral Analysis/LAICPMS/Element_Signals/"
...
Analysis <- Runs_612[[j]] %>%
  filter(`Time [Sec]` >= Pre_blank_cut_off & `Time [Sec]` <= Post_blank_cut_off) %>% # analysis started at 35 seconds
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 32, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_JCP[[j]]$`Time [Sec]`, na.rm = T)-52, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
...
assign(paste0(names(Runs_JCP[j]), "_Elementsignals"), datapoints)
Elementdata_JCP[[paste0(names(Runs_JCP[j]), "_Elementsignals")]] <- datapoints
...
Analysis <- Runs_JCP[[j]] %>%
  filter(`Time [Sec]` >= 32 & `Time [Sec]` <= max(`Time [Sec]`, na.rm = T)-52) %>% # analysis started at 32 seconds and finished 52 seconds before end of ablation
  mutate(across(all_of(c(2:11)), ~ ., .names = "{col}_analysis"))
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 32, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_DSC[[j]]$`Time [Sec]`, na.rm = T)-52, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
...
assign(paste0(names(Runs_DSC[j]), "_Elementsignals"), datapoints)
Elementdata_DSC[[paste0(names(Runs_DSC[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 40, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_16_1[[j]]$`Time [Sec]`, na.rm = T)-56, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
...
assign(paste0(names(Runs_Sample_23_16_1[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_16_1[[paste0(names(Runs_Sample_23_16_1[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 40, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_16_2[[j]]$`Time [Sec]`, na.rm = T)-56, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_16_2[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_16_2[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_16_2[[paste0(names(Runs_Sample_23_16_2[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 38, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_16_3[[j]]$`Time [Sec]`, na.rm = T)-58, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_16_3[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_16_3[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_16_3[[paste0(names(Runs_Sample_23_16_3[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = max(Runs_Sample_23_1_1[[j]]$`Time [Sec]`, na.rm = T)-48) + #postblank cut off
  geom_vline(xintercept = 41, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_1_1[[j]]$`Time [Sec]`, na.rm = T)-58, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_1_1[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_1_1[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_1_1[[paste0(names(Runs_Sample_23_1_1[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = max(Runs_Sample_23_1_2[[j]]$`Time [Sec]`, na.rm = T)-48) + #postblank cut off
  geom_vline(xintercept = 41, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_1_2[[j]]$`Time [Sec]`, na.rm = T)-59, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_1_2[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_1_2[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_1_2[[paste0(names(Runs_Sample_23_1_2[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  geom_vline(xintercept = 0) +
  geom_vline(xintercept = 29) + # preblank cut off
  geom_vline(xintercept = max(Runs_Sample_23_1_3[[j]]$`Time [Sec]`, na.rm = T)) +
  geom_vline(xintercept = max(Runs_Sample_23_1_3[[j]]$`Time [Sec]`, na.rm = T)-48) + #postblank cut off
  geom_vline(xintercept = 40, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_1_3[[j]]$`Time [Sec]`, na.rm = T)-59, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_1_3[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_1_3[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_1_3[[paste0(names(Runs_Sample_23_1_3[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = max(Runs_Sample_23_10_1[[j]]$`Time [Sec]`, na.rm = T)-46) + #postblank cut off
  geom_vline(xintercept = 40, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_10_1[[j]]$`Time [Sec]`, na.rm = T)-57, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_10_1[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_10_1[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_10_1[[paste0(names(Runs_Sample_23_10_1[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 44, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_10_2[[j]]$`Time [Sec]`, na.rm = T)-55, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_10_2[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_10_2[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_10_2[[paste0(names(Runs_Sample_23_10_2[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 41, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_10_3[[j]]$`Time [Sec]`, na.rm = T)-56, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_10_3[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_10_3[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_10_3[[paste0(names(Runs_Sample_23_10_3[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 47, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_6_1[[j]]$`Time [Sec]`, na.rm = T)-80, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_6_1[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_6_1[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_6_1[[paste0(names(Runs_Sample_23_6_1[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 42, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_6_2[[j]]$`Time [Sec]`, na.rm = T)-70, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_6_2[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_6_2[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_6_2[[paste0(names(Runs_Sample_23_6_2[j]), "_Elementsignals")]] <- datapoints
...
datapoints <- datapoints + 
  ...
  geom_vline(xintercept = 42, linetype = 2) + # start of analysis
  geom_vline(xintercept = max(Runs_Sample_23_6_3[[j]]$`Time [Sec]`, na.rm = T)-70, linetype = 2) + # end of analysis
  scale_y_log10(breaks = trans_breaks("log10", function(x) 10^x),
              labels = trans_format("log10", math_format(10^.x))) +
  annotation_logticks(sides = "l") +
  annotate("text", x = 100, y = 100, hjust = 2, vjust = 2, label = names(Runs_Sample_23_6_3[j]), col = "black") +
  ylab("Signal") +
  scale_fill_discrete(name = "Element") +
  theme_classic()


assign(paste0(names(Runs_Sample_23_6_3[j]), "_Elementsignals"), datapoints)
Elementdata_Sample_23_6_3[[paste0(names(Runs_Sample_23_6_3[j]), "_Elementsignals")]] <- datapoints
