...
Li_Mg_thermometry_plot_uninterpolated_constrained <- All_samples_thermometry_data_V2 %>%
      ...
      summarise(Timepoint = 2021-(distance.um/51),
            Li_Mg = Li_Ca/(Mg_Ca/1000),
            Li_Mg_proxy = ((log(Li_Mg/0.63))/-0.050),
            Li_Mg_proxy_TJW = (Li_Mg*-82.1)+33.18) %>%
  ungroup() %>%
...
Standard_errors %>%
  filter(Element %in% c("Li_Ca", "Mg_Ca", "Ba_Ca", "Sr_Ca", "U_Ca")) %>%
  mutate(mean_value= ifelse(Element == "Mg_Ca" | Element == "Sr_Ca", mean_value/1000, 
                            ifelse(Element == "U_Ca", mean_value*1000, mean_value)),
         standard_dev_2_av= ifelse(Element == "Mg_Ca" | Element == "Sr_Ca", standard_dev_2_av/1000, 
                            ifelse(Element == "U_Ca", standard_dev_2_av*1000, standard_dev_2_av)),
         standard_error_2_av= ifelse(Element == "Mg_Ca" | Element == "Sr_Ca", standard_error_2_av/1000, 
                            ifelse(Element == "U_Ca", standard_error_2_av*1000, standard_error_2_av)),
         max_value= ifelse(Element == "Mg_Ca" | Element == "Sr_Ca", max_value/1000, 
                            ifelse(Element == "U_Ca", max_value*1000, max_value)),
         min_value= ifelse(Element == "Mg_Ca" | Element == "Sr_Ca", min_value/1000, 
